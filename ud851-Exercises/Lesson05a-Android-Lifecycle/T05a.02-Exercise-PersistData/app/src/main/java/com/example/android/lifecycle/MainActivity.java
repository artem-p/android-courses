...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String LIFECYCLE_CALLBACKS_TEXT_KEY = "lifecycleCallbacks";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            String savedLifecycle = (String) savedInstanceState.get(LIFECYCLE_CALLBACKS_TEXT_KEY);
            if ( savedLifecycle != null) {
                mLifecycleDisplay.setText(savedLifecycle);
            }
        }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String callbacksText = String.valueOf(mLifecycleDisplay.getText());
        outState.putString(LIFECYCLE_CALLBACKS_TEXT_KEY, callbacksText);
    }
