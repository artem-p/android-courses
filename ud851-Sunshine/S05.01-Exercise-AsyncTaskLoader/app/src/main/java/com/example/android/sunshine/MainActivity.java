...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    private static final String LOCATION_KEY = "weatherRequestUrl";
    ...
    private void loadWeatherData() {
        ...
        weatherBundle.putString(LOCATION_KEY, location);
        ...
        if (weatherLoader == null) {
            loaderManager.initLoader(WEATHER_LOADER_ID, weatherBundle, this);
        } else {
            loaderManager.restartLoader(WEATHER_LOADER_ID, weatherBundle, this);
        }
