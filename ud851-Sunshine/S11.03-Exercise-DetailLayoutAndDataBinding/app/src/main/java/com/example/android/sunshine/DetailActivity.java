...
public class DetailActivity extends AppCompatActivity implements
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        String descriptionContentDescription = getString(R.string.a11y_forecast, description);

        mDetailBinding.primaryInfo.weatherDescription.setText(description);
        mDetailBinding.primaryInfo.weatherDescription.setContentDescription(descriptionContentDescription);

        String a11weatherIconDescription = getString(R.string.a11y_forecast_icon, description);
        mDetailBinding.primaryInfo.weatherIcon.setImageResource(weatherIconId);
        mDetailBinding.primaryInfo.weatherIcon.setContentDescription(a11weatherIconDescription);
