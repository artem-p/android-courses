...
public class DetailActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHighTemperatureView = (TextView) findViewById(R.id.tv_high_temp);
        mLowTemperatureView = (TextView) findViewById(R.id.tv_low_temp);
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        if (data != null && data.moveToFirst()) {
            ...
            String highStr = SunshineWeatherUtils.formatTemperature(this, highTemp);
            mHighTemperatureView.setText(highStr);

            double lowTemp = data.getDouble(INDEX_WEATHER_MIN_TEMP);
            String lowStr = SunshineWeatherUtils.formatTemperature(this, highTemp);
            mLowTemperatureView.setText(lowStr);
            ...
            mForecastSummary = String.format("%s - %s - %s/%s",
                                    dateText, description, highStr, lowStr);
        }
    }
