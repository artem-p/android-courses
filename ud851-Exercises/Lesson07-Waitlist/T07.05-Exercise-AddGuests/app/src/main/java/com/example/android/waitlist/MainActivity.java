...
public class MainActivity extends AppCompatActivity {
    ...
    public void addToWaitlist(View view) {
        String name = String.valueOf(mNewGuestNameEditText.getText());
        String partySize = String.valueOf(mNewPartySizeEditText.getText());

        if (name.isEmpty() || partySize.isEmpty()) return;
